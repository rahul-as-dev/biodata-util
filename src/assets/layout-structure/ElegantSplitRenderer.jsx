        ...
        <div className="relative z-10 h-full flex flex-col">
            ...
            <div className="h-[280px] w-full p-10 flex items-center justify-between" style={{ backgroundColor: styles.primaryColor }}>
                <div className="text-white w-2/3">
                    {header.enabled && ( <>
                        {header.icon && <img src={header.icon} className="h-16 w-16 mb-4 brightness-0 invert opacity-90" alt="Icon" />}
                        <h1 className="text-4xl font-bold uppercase tracking-[0.2em] mb-4 text-white">{header.text}</h1>
                    </> )}
