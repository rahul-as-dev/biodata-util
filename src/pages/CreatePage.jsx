...
import {
    ...
    Sun, Moon, GripVertical, Heart, Github
} from 'lucide-react';
            ...
            {/* <header className="h-14 shrink-0 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-4 z-20">
                <div className="flex items-center gap-2 font-bold text-lg">
                    ...
                    <a href="/" className="flex items-center gap-2 group">
                        <img src="/logo.svg" alt="VivahPatra Logo" className="h-13 w-13 group-hover:opacity-80 transition-opacity" />
                        <span className="text-rose-600"> Vivah Patra</span>
                    </a>
                </div>
